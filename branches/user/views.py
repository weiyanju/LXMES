...
class LoginView(View):
    ...
    def post(self, request):
        ...
        try:
            user = SysUser.objects.get(username=username, password=password)  # 明文比对
            if user.status != 1:
            ...
            print(e)
            return JsonResponse({'code': 500, 'info': '登录失败'})
