...
<script setup>
    ...
    imageUrl.value = getMediaUrl('userAvatar/' + form.value.avatar)
    const handleAvatarSuccess = (res) => {
        imageUrl.value = getMediaUrl('userAvatar/' + res.title)
    ...
    const handleConfirm = async () => {
        ...
        let result = await requestUtil.post("/api/user/updateAvatar", form.value);
